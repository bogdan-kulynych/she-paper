...
\begin{tikzpicture}
	[scale=.2,auto=center,every node/.style={rectangle,fill=blue!20}]
  	...
  	\draw[color=red!50,fill=red!0] (-10,2.5) rectangle (10,-15);
	\node[rectangle,fill=red!20] (client) at (0,0) {Клієнт};
	
  	\draw[color=red!50,fill=red!0] (10,2.5) rectangle (40,-15);
	...
	\node (compute) at (25,-5) { $f(\hat a_1, ..., \hat a_n, b_1, ..., b_m) = \hat y$ };

	\draw[->] (encrypt) -- (compute);
